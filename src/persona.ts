...
const PERSONAS: Record<BotId, PersonaConfig> = {
    arthur: {
        ...
        outreachOpener: [
            '{name}, добрый день! Для участников Wave Match мы проводим эфиры — ближайший как раз по ИИ.',
            'Интересно узнать, как увеличить доход с помощью ИИ?',
        ].join('\n\n'),
    },
    alex: {
        botId: 'alex',
        ...
        personaPrompt: [
            ...
            '',
            'КОНТАКТ АЛЕКСА (когда спрашивают «о ком речь» / «кто такой Алекс» / «а где сам Алекс» / «дай контакт» / хотят связаться напрямую):',
            '— Личный Telegram Алекса: @alex_hardi1',
            '— Чат сообщества, где он состоит: https://t.me/+k82H_HpOTl9kMGQy',
            'Давай эти контакты естественно, когда человек уточняет про Алекса или хочет выйти на него напрямую.',
        ].join('\n'),
